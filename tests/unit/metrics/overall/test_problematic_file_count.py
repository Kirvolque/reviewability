...
def test_none_problematic():
    ...
    assert result.value == MetricValue("overall.problematic_file_count", 0, MetricValueType.INTEGER)
...
def test_all_problematic():
    ...
    assert result.value == MetricValue("overall.problematic_file_count", 2, MetricValueType.INTEGER)
...
def test_some_problematic():
    ...
    result = metric.calculate([], [f1, f2])
    assert result.value == MetricValue("overall.problematic_file_count", 1, MetricValueType.INTEGER)
